...
<head>
    <meta charset="utf-8" />
    <title>{{request()->get('system_title')}} | Error 404</title>
			...
			<div class="d-flex flex-column-fluid flex-center">
				<div class="d-flex flex-center flex-column flex-lg-row p-10 p-lg-20">
					<div class="d-flex flex-column justify-content-center align-items-center align-items-lg-end flex-row-fluid order-2 order-lg-1">
						...
						<p class="font-size-h3 text-center text-muted font-weight-normal py-2">OOPS! The page you are looding for is not found</p>
					...
					<img src="{{asset('/storage/images/bg.jpg')}}" alt="image" class="w-100 w-sm-350px w-md-600px order-1 order-lg-2" />
				</div>
			</div>
			<!--end::Error-->
		</div>
