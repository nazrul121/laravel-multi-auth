...
<head>
    <meta charset="utf-8" />
    <title>{{request()->get('system_title')}} | Error 500</title>
			...
			<div class="d-flex flex-column-fluid flex-center">
				<div class="d-flex flex-center flex-column flex-lg-row p-10 p-lg-20">
					<div class="d-flex flex-column justify-content-center align-items-center align-items-lg-end flex-row-fluid order-2 order-lg-1">
						<!--begin::Content-->
						<h1 class="font-weight-boldest text-warning mb-5" style="font-size: 8rem">500</h1>
						<p class="font-size-h3 text-center text-muted font-weight-normal py-2">OOPS! Something went wrong in DB <b>connection</b></p>
					...
					<img src="{{asset('/storage/images/bg1.jpg')}}" alt="image" class="w-100 w-sm-350px w-md-600px order-1 order-lg-2" />
				</div>
			</div>
			<!--end::Error-->
		</div>
